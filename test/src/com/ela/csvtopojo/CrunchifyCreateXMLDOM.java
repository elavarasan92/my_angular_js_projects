...
public class CrunchifyCreateXMLDOM {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Element mainRootElement = doc.createElementNS("http://www.sec.gov/edgar/document/thirteenf/informationtable", "informationTable");
            doc.appendChild(mainRootElement);
            mainRootElement.setAttribute("xmlns:xsi", "http://wwww.w3.org/2001/XMLSchema-instance");
