...
public class GetAttx {
	public static void main(String[] args)
	{
	try{
		  UserAgent userAgent = new UserAgent();   
		  userAgent.visit("http://www.lnwshop.com/");
		  ...
		  System.out.println("anchor's href attribute:################################################ " + anchor.getAttx("meta"));  //print the anchor's href attribute
		  System.out.println("anchor's parent Element: " + anchor.getParent());    //print the anchor's parent element
		   
		  Element meta = userAgent.doc.findFirst("<head>").getElement(2);    //find 1st meta element in head section.
		  ...
		  System.out.println("meta's content attribute:################################################  " + meta.getAttx("content").trim());//print the meta's content attribute
